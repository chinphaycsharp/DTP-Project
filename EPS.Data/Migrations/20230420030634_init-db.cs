    ...
    public partial class initdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdentityClientId = table.Column<string>(nullable: false),
                    Description = table.Column<string>(maxLength: 100, nullable: false),
                    SecretKey = table.Column<string>(maxLength: 1000, nullable: false),
                    ClientType = table.Column<int>(nullable: false),
                    IsActive = table.Column<bool>(nullable: false),
                    RefreshTokenLifetime = table.Column<int>(nullable: false),
                    AllowedOrigin = table.Column<string>(maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdentityRefreshTokenId = table.Column<string>(nullable: false),
                    Identity = table.Column<string>(maxLength: 50, nullable: false),
                    ClientId = table.Column<string>(maxLength: 3000, nullable: false),
                    IssuedUtc = table.Column<DateTime>(nullable: false),
                    ExpiresUtc = table.Column<DateTime>(nullable: false),
                    RefreshToken = table.Column<string>(maxLength: 3000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Actor = table.Column<string>(maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateValidateToken = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivilegeId = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
