...
var services = {
    SERVICE_END_POINT: isDevEnv ? 'http://localhost:1938/' : '/EPS/Service',
    TOKEN_END_POINT: isDevEnv ? 'http://localhost:1938/api/token/auth' : '/EPS/Service/api/token/auth',
    API_END_POINT: isDevEnv ? 'http://localhost:1938/api/' : '/EPS/Service/api/',
    clientId: 'EPS',
    clientSecret: 'b0udcdl8k80cqiyt63uq',
    getAccessToken: function () {
        return JSON.parse(localStorage.getItem("_epsAccessToken"));
    },
    setAccessToken: function (token) {
        return localStorage.setItem("_epsAccessToken", JSON.stringify(token));
    },
    clearAccessToken: function () {
        localStorage.removeItem("_epsAccessToken");
    },
