...
namespace EPS.API.Controllers
{
    ...
    public class LookupController : BaseController
    {
        ...
        //[AllowAnonymous]
        //public async Task<ApiResult<DasboardModel>> GetInformation()
        //{
        //    ApiResult<DasboardModel> result = new ApiResult<DasboardModel>();
        //    DasboardModel dasboard = new DasboardModel();
        //    var a = await _lookupService.GetInformation();
        //    dasboard.totalCustomer = a[0];
        //    dasboard.totalPrice = a[1];
        //    dasboard.totalOrder = a[2];
        //    dasboard.topProducts = await _lookupService.GetTopProducts();
        //    dasboard.turnoverFollowMonths = await _lookupService.GetTurnoverFollowMonths();
        //    result.ResultObj = dasboard;
        //    result.Message = "";
        //    result.statusCode = 200;
        //    return result;
        //}
