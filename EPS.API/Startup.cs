...
namespace EPS.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EPSContext>(options => options.UseLazyLoadingProxies().UseMySql(
                    Configuration.GetConnectionString("EPS"),
            ...
            //UseMySql(Configuration.GetConnectionString("EPS")));
